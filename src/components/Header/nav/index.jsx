...
export default function Nav({ setIsClicked, mode, setMode }) {
  return (
    <motion.div variants={MenuSlideIn} initial='initial' animate='enter' exit='exit' className="fixed z-10 bg-gray-900 text-zinc-50 dark:text-black dark:bg-zinc-50 right-0 bottom-0 h-screen w-screen sm:w-[300px]">
