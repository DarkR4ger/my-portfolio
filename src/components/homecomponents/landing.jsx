...
export default function Landing() {
  ...
  const y2 = useTransform(smooth, [0, 1], [1000, 2000])
  ...
  return (
    <div className="container relative h-screen pt-20 flex flex-col overflow-hidden">
      <section className="h-full flex flex-col justify-center items-center md:flex-row">
        ...
        <div>
          <Image src='/images/programming-animate.svg' alt='svg' width={250} height={250} ></Image>
        </div>
      </section>
      <section className="relative flex flex-col justify-center items-center">
        ...
        <svg className="" width={41} height={100} viewBox="0 0 247 390" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fillRule="evenodd" clipRule='evenodd' strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit={1.5} >
